...
import { AiOutlineSearch, AiOutlineLeft, AiOutlineHome, AiOutlineApartment, AiOutlineSetting } from "react-icons/ai"
    ...
    <SSidebar isOpen={sidebarOpen}>
      ...
      {linksArray.map(({ icon, label, notification, to }) => (
        <SLinkContainer key={label} isActive={pathname === to}>
          <SLink to={to} tyle={!sidebarOpen ? { width: 'fit-content' } : {}}>
